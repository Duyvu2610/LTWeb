	...
	<div class="pt-[88px]">
		<div class="bg-right h-[560px] w-full relative md:bg-cover"
			...
			<div
				...
				<p class="text-lg pt-3 md:pt-6 md:text-3xl">Find and book a
					great experience</p>
			</div>
			<div
				class="absolute rounded-lg w-[97%] md:w-[75%] bg-white top-[230px] md:top-[400px] left-1/2 transform -translate-x-1/2
	  		py-5 px-4 shadow-2xl md:flex md:gap-5 md:items-end">
				<div class="md:flex-1">
					<div class="md:flex md:justify-between md:items-center relative">
						<div
							class="flex justify-center justify-between md:w-[400px] md:mb-5">
							<div class="flex">
						...
						<div
							class="absolute w-full h-0.5 bg-[#E7ECF3] top-1/2 md:top-full"></div>
					</div>
					<!--  -->
					<div class="mt-4 md:flex md:gap-2">
						<div
							class="px-4 py-2 bg-[#F4F5F7] rounded-lg mb-3 border md:relative">
							<p>Leaving From</p>
							<input placeholder="Where are you from?"
								class="py-2 bg-transparent"> <img alt="logo"
								src="./icons/arrow.svg"
						...
						<div
							...
							<img alt="logo" src="./icons/arrow.svg"
								class="hidden md:block absolute top-1/2 -right-5 -translate-y-1/2 z-10">
						</div>
						<div class="grid grid-cols-2 mb-3 md:flex-1 gap-2">
							<div
								class="px-4 col-span-1 py-2 bg-[#F4F5F7] rounded-lg border md:relative">
								<p>Check in</p>
								<input placeholder="Add date" class="py-2 bg-transparent"
									type="date"> <img alt="logo" src="./icons/arrow.svg"
									class="hidden md:block absolute top-1/2 -right-5 -translate-y-1/2 z-10">
							</div>
							<div class="px-4 py-2 bg-[#F4F5F7] rounded-lg  border ">
								<p>Check out</p>
								<input placeholder="Add date" class="py-2 bg-transparent"
									type="date">
							</div>
						...
						<div
							class="px-4 py-2 bg-[#F4F5F7] rounded-lg mb-3 border md:hidden">
							<p>Passenger</p>
