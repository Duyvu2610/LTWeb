<div class="px-4 py-6 mt-[88px] md:w-[800px] md:ml-36">
		...
		<nav class="flex mb-16 hidden md:block"  aria-label="Breadcrumb">
		...
		<div class = "md:w-[70%]">
			<p class="pb-4 border-b font-bold text-lg md:text-2xl md:pb-8">Confirm your Book</p>
			<div>
				<p class="py-4 font-bold text-lg">Your tour</p>
				<div
					class="bg-[#F4F4F6] rounded-xl flex justify-between px-4 py-2 mb-4">
					<div>
						<p class="font-semibold text-lg">Date</p>
						<p class="text-[#84878B]">June 27 - 30, 2020</p>
					</div>
					<svg xmlns="http://www.w3.org/2000/svg" width="20" height="21"
						viewBox="0 0 20 21" fill="none">
<path
							d="M3 16.9973H7.24C7.37161 16.998 7.50207 16.9728 7.62391 16.923C7.74574 16.8733 7.85656 16.8 7.95 16.7073L14.87 9.77935L17.71 7.00015C17.8037 6.90722 17.8781 6.79665 17.9289 6.67482C17.9797 6.553 18.0058 6.42233 18.0058 6.29036C18.0058 6.15838 17.9797 6.02772 17.9289 5.90589C17.8781 5.78407 17.8037 5.6735 17.71 5.58056L13.47 1.29181C13.377 1.19811 13.2664 1.12373 13.1446 1.07298C13.0227 1.02222 12.892 0.996094 12.76 0.996094C12.628 0.996094 12.4973 1.02222 12.3754 1.07298C12.2536 1.12373 12.143 1.19811 12.05 1.29181L9.23 4.12099L2.29 11.049C2.19732 11.1424 2.12399 11.2532 2.07423 11.375C2.02446 11.4968 1.99924 11.6272 2 11.7588V15.9975C2 16.2627 2.10536 16.517 2.29289 16.7044C2.48043 16.8919 2.73478 16.9973 3 16.9973ZM12.76 3.41119L15.59 6.24037L14.17 7.65996L11.34 4.83078L12.76 3.41119ZM4 12.1687L9.93 6.24037L12.76 9.06955L6.83 14.9978H4V12.1687ZM19 18.9967H1C0.734784 18.9967 0.48043 19.102 0.292893 19.2895C0.105357 19.477 0 19.7312 0 19.9964C0 20.2615 0.105357 20.5158 0.292893 20.7033C0.48043 20.8908 0.734784 20.9961 1 20.9961H19C19.2652 20.9961 19.5196 20.8908 19.7071 20.7033C19.8946 20.5158 20 20.2615 20 19.9964C20 19.7312 19.8946 19.477 19.7071 19.2895C19.5196 19.102 19.2652 18.9967 19 18.9967Z"
							fill="#84878B" />
</svg>
				</div>
				<div
...
<path
		...
		<div class="rounded-xl border px-4 py-6 md:absolute md:w-[335px] md:top-52 bg-white md:right-24">
			<div class="flex items-center">
				<p class="font-bold text-lg">AKL</p>
	...
	<path
        ...
        <path
			...
			<p class="text-[#84878B] border-b pb-4 w-1/2">1 Baggoge + Meals</p>
			<div class="flex justify-between py-6">
				<div>
					<p class="text-[#84878B]">Check in</p>
					<p class="font-semibold text-lg">May 15, 2021</p>
				</div>
				<div>
					<p class="text-[#84878B]">Check in</p>
					<p class="font-semibold text-lg">May 15, 2021</p>
			...
			<div class="flex flex-col gap-4 mt-4">
				<p class="text-lg font-bold">Fare summary</p>
		...
		<div>
			<p class="pb-4 font-bold text-lg py-4">Creadit Cards</p>
			...
			<div class="w-full max-w-lg mt-8">
				<div class=" rounded-lg">
					<form>
						<div class="">
							<div class="">
								<label for="card-number"
									...
									Number</label> <input type="text" name="card-number" id="card-number"
							...
							<div class="grid grid-cols-2 gap-4">
								<div class="">
									<label for="expiration-date"
										...
										Date</label> <input type="text" name="expiration-date"
										id="expiration-date" placeholder="MM / YY"
										class="w-full py-3 px-4 border border-gray-400 rounded-lg focus:outline-none focus:border-blue-500">
								</div>
								<div class="">
									<label for="cvv"
						...
						<div class="mt-8">
							<button type="submit"
								class="bg-[#3B71FE] px-4 hover:bg-blue-600 text-white font-medium py-3 rounded-lg focus:outline-none">Confirm
								and reverse</button>
						</div>
					</form>
				</div>
